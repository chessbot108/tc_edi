...
void generate_test_max()
{
	...
	test_cases.back() += to_string(n) + ' '; // need to make sure max val in array is max possible
	test_cases.back() += '\n';
...
int32_t main()
{
	...
	string directory = R"(C:\Users\elija\Desktop\CODING\Competitive Programming Problemsetting\TeamsCode\2021 Summer\My Problems\Rengoku's Flame Breathing\Tests\)";
